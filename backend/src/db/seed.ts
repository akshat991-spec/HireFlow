...
export async function seedDatabase(targetPool?: any): Promise<void> {
  ...
  const applications = [
...

    {
      id: 'app_cand_26',
      job_opening_id: 'job_eng_01',
      candidate_name: 'Nathaniel Drake',
      candidate_email: 'nathan.d@archeotech.io',
      source: 'GitHub',
      notes: 'Hired engineer with strong distributed systems background.',
      current_stage: Stage.HIRED,
      rejected_from_stage: null,
      applied_date: daysAgo(44),
      stage_entered_at: daysAgo(16),
    },
    {
      id: 'app_cand_27',
      job_opening_id: 'job_eng_02',
      candidate_name: 'Siddharth Rao',
      candidate_email: 'siddharth.r@infraforge.dev',
      source: 'Referral',
      notes: 'Infrastructure engineer candidate; concluded interview loop.',
      current_stage: Stage.REJECTED,
      rejected_from_stage: Stage.INTERVIEW,
      applied_date: daysAgo(47),
      stage_entered_at: daysAgo(24),
    },
    {
      id: 'app_cand_28',
      job_opening_id: 'job_prod_01',
      candidate_name: 'Amina Diallo',
      candidate_email: 'amina.d@productcraft.org',
      source: 'LinkedIn',
      notes: 'Senior Product candidate with extensive fintech experience.',
      current_stage: Stage.HIRED,
      rejected_from_stage: null,
      applied_date: daysAgo(51),
      stage_entered_at: daysAgo(21),
    },
    {
      id: 'app_cand_29',
      job_opening_id: 'job_design_01',
      candidate_name: 'Casper Lindqvist',
      candidate_email: 'casper.l@nordicdesign.se',
      source: 'Dribbble',
      notes: 'Design systems lead portfolio review.',
      current_stage: Stage.REJECTED,
      rejected_from_stage: Stage.SCREENING,
      applied_date: daysAgo(54),
      stage_entered_at: daysAgo(41),
    },
    {
      id: 'app_cand_30',
      job_opening_id: 'job_sales_01',
      candidate_name: 'Genevieve Moreau',
      candidate_email: 'genevieve.m@salescorp.fr',
      source: 'Direct',
      notes: 'Strategic AE candidate for Central European market.',
      current_stage: Stage.HIRED,
      rejected_from_stage: null,
      applied_date: daysAgo(58),
      stage_entered_at: daysAgo(26),
    },
    {
      id: 'app_cand_31',
      job_opening_id: 'job_eng_01',
      candidate_name: 'Tariq Al-Sabah',
      candidate_email: 'tariq.s@cloudcore.kw',
      source: 'LinkedIn',
      notes: 'Early applicant for full stack role.',
      current_stage: Stage.REJECTED,
      rejected_from_stage: Stage.SCREENING,
      applied_date: daysAgo(61),
      stage_entered_at: daysAgo(52),
    },
    {
      id: 'app_cand_32',
      job_opening_id: 'job_eng_02',
      candidate_name: 'Fiona Gallagher',
      candidate_email: 'fiona.g@devopsireland.ie',
      source: 'Referral',
      notes: 'Staff infra engineer hired early in the quarter.',
      current_stage: Stage.HIRED,
      rejected_from_stage: null,
      applied_date: daysAgo(65),
      stage_entered_at: daysAgo(35),
    },
    {
      id: 'app_cand_33',
      job_opening_id: 'job_prod_01',
      candidate_name: 'Leonid Volkov',
      candidate_email: 'leonid.v@techproduct.io',
      source: 'Tech Meetup',
      notes: 'Product leader candidate with B2B analytics focus.',
      current_stage: Stage.REJECTED,
      rejected_from_stage: Stage.INTERVIEW,
      applied_date: daysAgo(68),
      stage_entered_at: daysAgo(45),
    },
    {
      id: 'app_cand_34',
      job_opening_id: 'job_design_01',
      candidate_name: 'Mei-Ling Zhou',
      candidate_email: 'meiling.z@uxstudio.sg',
      source: 'Career Portal',
      notes: 'Accessibility & design specialist hired in previous cohort.',
      current_stage: Stage.HIRED,
      rejected_from_stage: null,
      applied_date: daysAgo(72),
      stage_entered_at: daysAgo(42),
    },
    {
      id: 'app_cand_35',
      job_opening_id: 'job_sales_01',
      candidate_name: 'Darius Vance',
      candidate_email: 'darius.v@enterprisesolutions.com',
      source: 'Direct',
      notes: 'Mid-market sales applicant.',
      current_stage: Stage.REJECTED,
      rejected_from_stage: Stage.SCREENING,
      applied_date: daysAgo(75),
      stage_entered_at: daysAgo(68),
    },
    {
      id: 'app_cand_36',
      job_opening_id: 'job_eng_01',
      candidate_name: 'Helena Berg',
      candidate_email: 'helena.b@stockholmdev.se',
      source: 'LinkedIn',
      notes: 'Full stack engineer hired at start of quarter.',
      current_stage: Stage.HIRED,
      rejected_from_stage: null,
      applied_date: daysAgo(79),
      stage_entered_at: daysAgo(48),
    },
    {
      id: 'app_cand_37',
      job_opening_id: 'job_eng_02',
      candidate_name: 'Kavita Chawla',
      candidate_email: 'kavita.c@cloudscale.in',
      source: 'Referral',
      notes: 'Cloud architect applicant.',
      current_stage: Stage.REJECTED,
      rejected_from_stage: Stage.SCREENING,
      applied_date: daysAgo(82),
      stage_entered_at: daysAgo(75),
    },
    {
      id: 'app_cand_38',
      job_opening_id: 'job_prod_01',
      candidate_name: 'Oliver Queen',
      candidate_email: 'oliver.q@productarrow.com',
      source: 'Direct',
      notes: 'Senior PM applicant from quarter start.',
      current_stage: Stage.REJECTED,
      rejected_from_stage: Stage.INTERVIEW,
      applied_date: daysAgo(85),
      stage_entered_at: daysAgo(60),
    },
    {
      id: 'app_cand_39',
      job_opening_id: 'job_design_01',
      candidate_name: 'Beatriz Santos',
      candidate_email: 'beatriz.s@designbrasil.br',
      source: 'Dribbble',
      notes: 'Principal designer hired at start of hiring initiative.',
      current_stage: Stage.HIRED,
      rejected_from_stage: null,
      applied_date: daysAgo(88),
      stage_entered_at: daysAgo(55),
    },
    {
      id: 'app_cand_40',
      job_opening_id: 'job_sales_01',
      candidate_name: 'Jonas Weber',
      candidate_email: 'jonas.w@saassales.de',
      source: 'LinkedIn',
      notes: 'Enterprise account lead applicant.',
      current_stage: Stage.REJECTED,
      rejected_from_stage: Stage.SCREENING,
      applied_date: daysAgo(89),
      stage_entered_at: daysAgo(81),
    },
  ...
  const panelAssignments = [
    ...
    { appId: 'app_cand_26', userId: 'usr_interviewer_01' }, // Nathaniel Drake -> Alex Rivera
    { appId: 'app_cand_28', userId: 'usr_interviewer_02' }, // Amina Diallo -> Elena Rostova
    { appId: 'app_cand_32', userId: 'usr_interviewer_03' }, // Fiona Gallagher -> Marcus Brody
    { appId: 'app_cand_34', userId: 'usr_interviewer_01' }, // Mei-Ling Zhou -> Alex Rivera
    { appId: 'app_cand_36', userId: 'usr_interviewer_02' }, // Helena Berg -> Elena Rostova
  ];
